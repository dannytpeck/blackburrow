...
function Home({ accountManager, setAccountManager, accountManagerId, setAccountManagerId, accountManagers, setAccountManagers, newOrHistorical, setNewOrHistorical }) {
  ...
  return (
    <section className="border" id="home">
      ...
      <p>Thank you for using ADURO’s Custom Tile Request Tool. This tool was designed to assist you in creating customer-specific content for your Human Performance platform.</p>
      <p>Note: The tile creation process can take up to 30 days.</p>
